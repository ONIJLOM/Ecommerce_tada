        ...
        <div class="row row-50">
          <div class="col-md-6 col-lg-4">
            <h5 class="footer-modern-title oh-desktop">
              <span class="d-inline-block wow slideInLeft"
...
<!--                   <li><a href="#">Fideos</a></li>
          ...
          <div class="col-lg-4 col-xl-5">
            <h5 class="footer-modern-title oh-desktop">
              <span class="d-inline-block wow slideInLeft"> Más información</span>
            </h5>
            <p class="wow fadeInRight">
              Ingresa tu email para las últimas ofertas y novedades.
            </p>
            <!-- RD Mailform-->
            <form
            ...
            >
              <div class="form-wrap wow slideInUp">
                <input
                  class="form-input"
                  id="subscribe-form-2-email"
                  type="email"
                  name="email"
                  />
                  {{-- data-constraints="@Email @Required" --}}
                <label class="form-label" for="subscribe-form-2-email"
              ...
              <div class="form-button form-button-2 wow slideInRight">
                <button
                  ...
                  type="submit"
                >
                  <span class="d-none d-xl-inline-block">Enviar</span
            ...
            <div class="row row-30 align-items-center text-lg-center">
              ...
              <div class="col-md-5 col-xl-6">
                <div class="iso-1">
                  <span
                    ><img
                      src="images/likelikelikelike.png"
                      alt=""
                      width="58"
                      height="25" /></span
    ...
    <div class="footer-modern-line-3">
      <div class="container">
        <div class="row row-10 justify-content-between">
          <div class="col-md-6">
            <span>PI MZ13 Y 14 barrio industrial Santa Cruz de la Sierra,Bolivia</span>
          </div>
